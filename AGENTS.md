...
- Python tooling and tests must use only the Python standard library. Do not add third-party Python packages, pip installation steps, or virtual environment requirements.
