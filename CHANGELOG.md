...
- An initial Grafana operations dashboard and tested Prometheus alerts with
  ...
  and shared inventory gauges are deduplicated across replicas.
...
- Added a deterministic operational-contract snapshot and blocking
  ...
  serialized graph names. Batch and traversal-depth limits track validated runtime bounds, and
