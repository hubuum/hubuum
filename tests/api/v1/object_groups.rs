...
use crate::models::{
    ...
    MAX_OBJECT_GROUP_CURSOR_LENGTH, NewHubuumClass, NewHubuumObject, Permissions, ServiceAccountID,
    TaskID, UpdateHubuumObject,
};
...
#[path = "object_groups/basic.rs"]
mod basic;
#[path = "object_groups/computed.rs"]
mod computed;
#[path = "object_groups/contracts.rs"]
mod contracts;
#[path = "object_groups/cursor.rs"]
mod cursor;
#[path = "object_groups/external_authorization.rs"]
