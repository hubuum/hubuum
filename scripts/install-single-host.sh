...
write_deployment_env() {
  ...
  printf 'HUBUUM_MAX_TOKEN_LIFETIME_HOURS=8760\n'
  printf 'HUBUUM_TOKEN_RETENTION_PURGE_ENABLED=true\n'
  printf 'HUBUUM_TOKEN_RETENTION_DAYS=30\n'
  printf 'HUBUUM_TOKEN_RETENTION_PURGE_INTERVAL_SECONDS=3600\n'
  printf 'HUBUUM_TOKEN_RETENTION_PURGE_BATCH_SIZE=1000\n'
  printf 'HUBUUM_DEFAULT_PAGE_LIMIT=100\n'
  printf 'HUBUUM_MAX_PAGE_LIMIT=250\n'
  printf 'HUBUUM_SCHEMA_MAX_BYTES=65536\n'
  printf 'HUBUUM_SCHEMA_MAX_EXPANDED_WORK=16384\n'
  printf 'HUBUUM_SCHEMA_MAX_INSTANCE_BYTES=2097152\n'
  printf 'HUBUUM_SCHEMA_MAX_INSTANCE_WORK=268435456\n'
...
cat >> "$INSTALL_DIR/compose.yml" <<'EOF'
    ...
    environment:
      ...
      HUBUUM_SCHEMA_MAX_BYTES: ${HUBUUM_SCHEMA_MAX_BYTES:-65536}
      HUBUUM_SCHEMA_MAX_EXPANDED_WORK: ${HUBUUM_SCHEMA_MAX_EXPANDED_WORK:-16384}
      HUBUUM_SCHEMA_MAX_INSTANCE_BYTES: ${HUBUUM_SCHEMA_MAX_INSTANCE_BYTES:-2097152}
      HUBUUM_SCHEMA_MAX_INSTANCE_WORK: ${HUBUUM_SCHEMA_MAX_INSTANCE_WORK:-268435456}
...
cat >> "$INSTALL_DIR/compose.yml" <<'EOF'
    ...
    environment:
      ...
      HUBUUM_MAX_TOKEN_LIFETIME_HOURS: ${HUBUUM_MAX_TOKEN_LIFETIME_HOURS}
      HUBUUM_TOKEN_RETENTION_PURGE_ENABLED: ${HUBUUM_TOKEN_RETENTION_PURGE_ENABLED}
      HUBUUM_TOKEN_RETENTION_DAYS: ${HUBUUM_TOKEN_RETENTION_DAYS}
      HUBUUM_TOKEN_RETENTION_PURGE_INTERVAL_SECONDS: ${HUBUUM_TOKEN_RETENTION_PURGE_INTERVAL_SECONDS}
      HUBUUM_TOKEN_RETENTION_PURGE_BATCH_SIZE: ${HUBUUM_TOKEN_RETENTION_PURGE_BATCH_SIZE}
