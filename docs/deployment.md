...
- `HUBUUM_MAX_TOKEN_LIFETIME_HOURS=8760`
- `HUBUUM_TOKEN_RETENTION_PURGE_ENABLED=true`
- `HUBUUM_TOKEN_RETENTION_DAYS=30`
- `HUBUUM_TOKEN_RETENTION_PURGE_INTERVAL_SECONDS=3600`
- `HUBUUM_TOKEN_RETENTION_PURGE_BATCH_SIZE=1000`
