...
async fn get_class_relation(
    ...
    Ok(JsonResponse::new(relation, StatusCode::OK))
}
...
async fn create_class_relation(
    ...
    Ok(JsonResponse::new(relation, StatusCode::CREATED))
}
...
async fn get_object_relations(
    ...
    PaginatedJsonResponse::new(object_relations, total_count, StatusCode::OK, &params)
}
