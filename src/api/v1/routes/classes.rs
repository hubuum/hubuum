...
pub fn config(cfg: &mut web::ServiceConfig) {
    cfg.service(classes::get_class_by_name)
        ...
        .service(classes::get_related_classes_by_name)
        .service(classes::get_related_class_relations_by_name)
        .service(classes::get_related_class_graph_by_name)
        .service(classes::get_objects_in_class_by_name)
        .service(classes::create_object_in_class_by_name)
        .service(classes::get_object_in_class_by_name)
        .service(classes::patch_object_in_class_by_name)
        .service(classes::patch_object_data_by_name_in_class)
        .service(classes::delete_object_in_class_by_name)
        ...
        .service(computed_fields::get_shared_computed_field)
        ...
        .service(classes::get_object_aggregates)
        ...
        .service(classes::patch_object_data_in_class)
        ...
        .service(classes::get_class_relation)
