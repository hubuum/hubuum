...
use crate::storage::{
    ...
    EventDeliveryWorkerStorage, EventFanoutStorage, EventHealthStorage, EventRetentionStorage,
    ExecutionStorage, ExportTemplateStorage, ExternalIdentityStorage, GroupMembershipStorage,
    GroupStorage, HistoryStorage, IdentityScopeStorage, ImportStorage, InventoryStorage,
    LocalIdentityCredentialStorage, MetricsStorage, ObjectAggregateStorage, ObjectRelationStorage,
    ObjectStorage, OperationalStateStorage, PrincipalStorage, RelationQueryStorage,
    RemoteTargetStorage, RestoreStorage, ServiceAccountStorage, StorageAuditEvent,
    StorageAuditEventListQuery, StorageAuthenticatedToken, StorageAuthenticationAttempt,
    StorageAuthenticationIdentity, StorageAuthenticationTokenScope,
    StorageAuthenticationTokenScopeQuery, StorageAuthorizationClassResource,
    StorageAuthorizationCollection, StorageAuthorizationCollectionAccessQuery,
    StorageAuthorizationCollectionCandidateQuery, StorageAuthorizationCollectionGrantListQuery,
    ...
    StorageAuthorizationObjectResource, StorageAuthorizationPermissionSet,
    StorageAuthorizationPermissionSetQuery, StorageAuthorizationPolicySnapshotRow,
    StorageAuthorizationPrincipal, StorageAuthorizationPrincipalCollectionPageQuery,
    StorageAuthorizationPrincipalCollectionQuery, StorageAuthorizationResourceIds,
    StorageBackendDescriptor, StorageBackendKind, StorageBackupBudget, StorageBackupOutput,
    StorageBackupOutputSummary, StorageBackupSnapshot, StorageBidirectionalRelatedObjectsQuery,
    StorageCandidatePage, StorageCapability, StorageCatalogListQuery, StorageClass,
    StorageClassComputationState, StorageClassGraphRow, StorageClassRelation,
    StorageClassWithCollection, StorageCollection, StorageComputedFieldDefinition,
    ...
    StorageComputedObjectPage, StorageDefaultAdminBootstrap, StorageError, StorageEventDelivery,
    StorageEventDeliveryBatch, StorageEventDeliveryClaim, StorageEventDeliveryHealthSnapshot,
    StorageEventDeliveryLease, StorageEventDeliveryListQuery, StorageEventFanoutOutcome,
    StorageEventMetricsSnapshot, StorageEventRetentionBatch, StorageEventRetentionBatchId,
    StorageEventRetentionSummary, StorageEventSink, StorageEventSinkCreate, StorageEventSinkDelete,
    ...
    StorageExportTemplateCreate, StorageExportTemplateDelete, StorageExportTemplateHistoryRecord,
    StorageExportTemplateListQuery, StorageExportTemplateReplace, StorageExternalPrincipalState,
    StorageExternalUserSync, StorageGroupCreate, StorageGroupListQuery, StorageGroupMember,
    StorageGroupUpdate, StorageHistoryAsOfQuery, StorageHistoryListQuery,
    StorageHistoryPrincipalName, StorageIdentityGroup, StorageIdentityScope,
    StorageIdentityScopeEnsure, StorageImportApply, StorageImportCollectionKey, StorageImportMode,
    StorageImportPlan, StorageImportPreflight, StorageImportResult, StorageImportTaskResult,
    StorageInventoryCounts, StorageInventoryGaugeSnapshot, StorageLocalPasswordReset,
    StorageMutationOutcome, StorageNotification, StorageNotificationListener,
    StorageNotificationShutdown, StorageObject, StorageObjectAggregateAuthorization,
    StorageObjectAggregatePage, StorageObjectAggregateQuery, StorageObjectGraphRow,
    StorageObjectHistoryAsOfQuery, StorageObjectHistoryListQuery, StorageObjectHistoryRecord,
    StorageObjectRelation, StorageObjectRelationsTouchingIdsQuery, StorageObserver,
    StorageOperationalExportTemplateAuditEntry, StorageOperationalExportTemplateHealth,
    StorageOperationalTaskQueueSnapshot, StoragePage, StoragePersonalComputedFieldCreate,
    ...
    StoragePrincipalTokensRevoke, StorageReadinessSnapshot, StorageRelatedObjectForRootRow,
    StorageRelatedObjectIncludeRow, StorageRelatedObjectsForRootsQuery, StorageRelationGraphQuery,
    ...
    StorageRemoteTargetHistoryRecord, StorageRemoteTargetInvocation, StorageRemoteTargetListQuery,
    ...
    StorageRestoreJob, StorageRestoreStageCreate, StorageRestoreStatus, StorageServiceAccount,
