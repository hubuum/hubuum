...
impl RemoteTargetStorage for PostgresStorage {
    async fn get_remote_target(&self, target_id: i32) -> Result<StorageRemoteTarget, StorageError> {
        hubuum_storage_postgres::operations::remote_target::get_remote_target(
            self.runtime(),
            target_id,
        )
        .await
    ...
    async fn list_remote_targets(
        ...
        hubuum_storage_postgres::operations::remote_target::list_remote_targets(
            self.runtime(),
            query,
        )
        .await
    ...
    async fn create_remote_target(
        ...
        hubuum_storage_postgres::operations::remote_target::create_remote_target(
            self.runtime(),
            request,
        )
        .await
    ...
    async fn update_remote_target(
        ...
        hubuum_storage_postgres::operations::remote_target::update_remote_target(
            self.runtime(),
            request,
        )
        .await
    ...
    async fn delete_remote_target(
        ...
        hubuum_storage_postgres::operations::remote_target::delete_remote_target(
            self.runtime(),
            request,
        )
        .await
    ...
    async fn record_remote_target_invocation(
        ...
        hubuum_storage_postgres::operations::remote_target::record_remote_target_invocation(
            self.runtime(),
            request,
        )
        .await
