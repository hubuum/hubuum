...
pub(crate) use hubuum_storage_core::{
    ...
    RemoteTargetStorage, RestoreStorage, RetainedEvent, StorageClass, StorageClassComputationState,
    ...
    StorageGraphClass, StorageGraphObject, StorageGraphResource, StorageIdentityPage,
    StorageIdentityScope, StorageIdentityScopeEnsure, StorageObject,
