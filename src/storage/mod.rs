...
pub(crate) use hubuum_storage_core::{
    ...
    RelationTouchingQuery, RemoteTargetHistoryRecord, RetainedEvent, StorageClass,
    StorageClassGraphRow, StorageClassRelation, StorageCollection, StorageComputedFieldError,
    StorageComputedObject, StorageComputedScope, StorageGraphClass, StorageGraphObject,
    StorageGraphResource, StorageObject, StorageObjectAggregateAuthorizationCandidate,
    ...
    StorageResourceScope, StorageSharedComputedScope, StorageVisibility, UnifiedSearchClass,
