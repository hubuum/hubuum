...
pub const DEFAULT_TASK_POLL_INTERVAL_MS: u64 = 5_000;
...
pub const DEFAULT_COMPUTED_REINDEX_BATCH_SIZE: usize = 100;
pub const MAX_COMPUTED_REINDEX_BATCH_SIZE: usize = 1_000;
pub const DEFAULT_EVENT_FANOUT_WORKERS: usize = 1;
pub const DEFAULT_EVENT_FANOUT_BATCH_SIZE: usize = 100;
pub const DEFAULT_EVENT_FANOUT_POLL_INTERVAL_MS: u64 = 5_000;
...
pub const DEFAULT_EVENT_DELIVERY_POLL_INTERVAL_MS: u64 = 5_000;
...
pub const DEFAULT_BACKUP_MAX_CAPTURE_ROWS: usize = 1_000_000;
...
pub const DEFAULT_EXPORT_STORAGE_QUERY_BUDGET_MS: u64 = 0;
pub const DEFAULT_EXPORT_DB_STATEMENT_TIMEOUT_MS: u64 = DEFAULT_EXPORT_STORAGE_QUERY_BUDGET_MS;
pub const DEFAULT_TOKEN_LIFETIME_HOURS: i64 = 24;
pub const DEFAULT_MAX_TOKEN_LIFETIME_HOURS: i64 = 24 * 365;
pub const DEFAULT_TOKEN_RETENTION_PURGE_ENABLED: bool = true;
pub const DEFAULT_TOKEN_RETENTION_DAYS: i64 = 30;
pub const DEFAULT_TOKEN_RETENTION_PURGE_INTERVAL_SECONDS: u64 = 3_600;
pub const DEFAULT_TOKEN_RETENTION_PURGE_BATCH_SIZE: usize = 1_000;
...
pub const DEFAULT_TRACING_CONNECT_TIMEOUT_MS: u64 = 2_000;
pub const DEFAULT_TRACING_EXPORT_TIMEOUT_MS: u64 = 5_000;
pub const DEFAULT_TRACING_FLUSH_TIMEOUT_MS: u64 = 5_000;
pub const DEFAULT_TRACING_QUEUE_CAPACITY: usize = 2_048;
pub const DEFAULT_TRACING_BATCH_SIZE: usize = 512;
pub const DEFAULT_TRACING_SAMPLE_RATIO: f64 = 0.1;
pub const DEFAULT_TRACING_SERVICE_NAME: &str = "hubuum";
pub const DEFAULT_TRACING_SERVICE_NAMESPACE: &str = "hubuum";
pub const DEFAULT_TRACING_DEPLOYMENT_ENVIRONMENT: &str = "production";
