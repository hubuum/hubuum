...
pub mod resources {
    ...
    pub use crate::{
        ResourceStorage, StorageClassRelation, StorageCollection, StorageObject,
...
pub mod operational {
    ...
    pub use crate::{OperationalStorage, StorageQueryBudget, StorageTaskKind, StorageTaskStatus};
}
