...
pub enum PostgresFaultPoint {
    ...
    PageAfterCount,
    SchemaImpactAfterFindings,
    SchemaReportAfterCheckpoint,
...
impl PostgresFaultPoint {
    const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::SchemaImpactAfterFindings => "schema_impact_after_findings",
            Self::SchemaReportAfterCheckpoint => "schema_report_after_checkpoint",
