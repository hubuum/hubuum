...
#[test]
fn oversized_output_is_rejected_without_allocating_the_complete_output() {
...
#[test]
fn intermediate_allocation_failure_is_contained_in_the_worker() {
...
#[test]
fn macro_capture_failure_is_contained_in_the_worker() {
